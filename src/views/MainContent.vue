...
<script lang="ts">
    ...
    export default class MainContent extends Vue{
        ...
        // mainTabs:any;
        // mainTabsActiveName:any;
        // @Getter("mainTabs")mainTabs:any;
        // @Getter("mainTabsActiveName")mainTabsActiveName:any;
        // @Action("updateMainTabs")updateMainTabs:any;
        // @Action("updateMainTabsActiveName")updateMainTabsActiveName:any;
        // @Watch('mainTabs') changeMainTabs(val:any){
        //     this.updateMainTabs('updateMainTabs', val);
        // };
        // @Watch('mainTabsActiveName') changeMainTabsActiveName(val:any){
        //     this.updateMainTabsActiveName('updateMainTabsActiveName',val);
        // }
        //以下相当于使用computed计算属性
        get mainTabs():any[]{
        ...
        tabsCloseOtherHandle () {
            this.mainTabs = this.mainTabs.filter((item:any) => item.name === this.mainTabsActiveName)
        };
        // tabs, 关闭全部
        tabsCloseAllHandle () {
            this.mainTabs = []
